...
- Builder Pass needs authenticated GitHub linking, a GitHub account at least 180 days old, at least 10 qualifying GitHub contributions in the previous 180 days, at least one wallet whose ownership is proven with a server nonce and signature, and qualifying real Arc onchain activity. Discord is supporting evidence only and never independently grants Builder eligibility.
...
- Builder tiers use qualifying Arc transactions: Bronze 2+, Silver 10+, Gold 50+, Platinum 100+, Diamond 1,000+. Tier upgrades keep the same Builder credential number and never downgrade automatically.
