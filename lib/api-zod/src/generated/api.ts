...
export const ListMyPassesResponse = zod.object({
  ...
  "arcActivityAvailable": zod.boolean().nullish().describe('Whether Arc onchain activity was successfully indexed for the latest verification. A false value never represents verified zero activity.'),
  "arcActivityPartial": zod.boolean().nullish().describe('Whether only safely captured Arc activity was available because a provider stopped before the full history completed. Counts remain lower bounds and are never fabricated.'),
